...
const params = {
    strokeColor: "#1f3d2a", //couleur du conteur
    defaultColor: "#38764e", //couleur des pays
    hoverColor: "#ecf5b0", // couleur quand on passe le cursor
    
    fogDistance: 5, // l'effet du back des pays 
    strokeWidth: 1, // taille de conteur des frontieres
